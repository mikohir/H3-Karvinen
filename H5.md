...
Viimeiseen tehtävään päätin asentaa matopelin sijasta terminaalissa pelattavan [Tetriksen](https://github.com/DavidGriffith/tint) (TINT) ja muuttaa jotakin sen asetuksia. Loin tintille oman kansion salttiin, sekä asensin paketin suoraan sinne luomani tilan kautta:

![image](https://user-images.githubusercontent.com/82265726/116998393-d327f980-ace6-11eb-90a6-a12963c88a42.png)

Tämän jälkeen kokeilin että peli toimii. Suoritus oli heikko, mutta syytän erikoisia oletusnäppäimiä.

![image](https://user-images.githubusercontent.com/82265726/116999736-b7bdee00-ace8-11eb-946a-46f993e6edd0.png)

Muuttaakseni oletusnäppäimet nykyaikaisemmiksi (wasd), etsin find -komennolla asetustiedostot ja kopioin sekä lisään ne tintin salt -tilaan:
...
TINT. David Griffith GitHub, 2019. Luettavissa: [https://github.com/DavidGriffith/tint](https://github.com/DavidGriffith/tint). Luettu 4.5.2021.
