...
Tämän jälkeen ongelma oli se, että pelitiedostoa lukiessa emulaattori antoi virhekoodin:

Pitkän päänsäryn jälkeen löysin ratkaisun samaan virhekoodiin. Piti vaihtaa emulaattorin videon ulostulon asetus yksinkertaiseksi (simple):
...
VBA-m. Github.com, 2021. Luettavissa: [https://github.com/visualboyadvance-m/visualboyadvance-m](https://github.com/visualboyadvance-m/visualboyadvance-m). Luettu 17.5.2021.
